...
! function (e, t) {
  ...
  H.RegisterPlugins = function (e) {
    ...
    function b(e, t, n) {
      var r = e = function i(e) {
        ...
        o = null;
      return f.opts.fullPage && (r = f.html.extractNode(e, "body") || (0 <= e.indexOf("<body") ? "" : e), n && (o = f.html.extractNode(e, "head") || "")), r = v(r, t), o && (o = v(o, t)),
        function a(e) {
  ...
  H.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), H.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", H.LinkRegExTLD = "((".concat(H.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), H.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(H.LinkRegExCommon, ")"), H.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(H.LinkRegExCommon, ")"), H.LinkRegExWWW = "(www\\.".concat(H.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), H.LinkRegEx = "(".concat(H.LinkRegExTLD, "|").concat(H.LinkRegExHTTP, "|").concat(H.LinkRegExWWW, "|").concat(H.LinkRegExAuth, ")").concat(H.LinkRegExEnd), H.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], H.MAIL_REGEX = /.+@.+\..+/i, H.MODULES.helpers = function (i) {
    ...
    function n(e, t) {
      if (!1 !== a.events.trigger("commands.before", s.merge([e], t || []))) {
        var n = H.COMMANDS[e] && H.COMMANDS[e].callback || i[e],
          r = !0,
          o = !1;
    ...
    return Object.assign(c, {
      ...
      _init: function f() {
        a.events.on("keydown", function (e) {
          ...
          var t = a.selection.element();
          if (t && "HR" === t.tagName)
            if (e.which === H.KEYCODE.ARROW_LEFT || e.which === H.KEYCODE.ARROW_UP) {
    ...
    return {
      _startEnter: function E(e) {
        ...
        if (g.node.isEmpty(n, !0) && r) {
          ...
          var c = "";
          for (c = l.parentNode && "LI" === l.parentNode.tagName ? "".concat(s, "<li>").concat(H.MARKERS, "<br>").concat(a) : i ? "".concat(s, "<").concat(i, ">").concat(H.MARKERS, "<br></").concat(i, ">").concat(a) : "".concat(s + H.MARKERS, "<br>").concat(a);
      ...
      _del: function f(e) {
        ...
        if (r) {
          ...
          if (s === g.el) return !1;
          if (s = s.nextSibling, g.node.isBlock(s)) H.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (m(e).replaceWith(H.MARKERS), (t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && m(t[t.length - 1]).remove(), m(n).append(m(s).html()), m(s).remove());
          else
            for ((t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && m(t[t.length - 1]).remove(), m(e).replaceWith(H.MARKERS); s && !g.node.isBlock(s) && "BR" !== s.tagName;) m(n).append(m(s)), s = s.nextSibling
        }
      }
    }
    ...
    function f(e) {
      ...
      if (n = n.previousSibling, !u.node.isBlock(n) && u.node.isEditable(n)) {
        ...
        if (n.nodeType === Node.TEXT_NODE) {
          ...
          if (0 === n.textContent.length)
            if (i && u.opts.keepFormatOnDelete) h(n).after(H.INVISIBLE_SPACE + H.MARKERS);
            else if (0 !== r.length && u.node.isBlock(n.parentNode)) h(n).after(H.MARKERS);
          ...
          } else h(n.parentNode).after(H.MARKERS), h(n.parentNode).remove();
          else h(n).after(H.MARKERS)
      ...
      } else if (H.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n)))
        if (u.node.isDeletable(n)) h(e).replaceWith(H.MARKERS), h(n).remove();
        else if (u.node.isEmpty(n) && !u.node.isList(n)) h(n).remove(), h(e).replaceWith(H.MARKERS);
      else {
    ...
    function s(e) {
      ...
      if (null !== n) {
        ...
        if (u.node.isBlock(n) && (u.node.isEditable(n) || u.node.isDeletable(n)) && i && H.NO_DELETE_TAGS.indexOf(i.tagName) < 0)
          if (u.node.isDeletable(i)) h(i).remove(), h(e).replaceWith(H.MARKERS);
          else if (u.node.isBlock(i) && u.node.isEditable(i))
          if (u.node.isList(i))
            if (u.node.isEmpty(n, !0)) h(n).remove(), h(i).find("li").first().prepend(H.MARKERS);
            else {
          ...
          if ((o = u.node.contents(i)).length && "BR" === o[0].tagName && h(o[0]).remove(), "BLOCKQUOTE" !== i.tagName && "BLOCKQUOTE" === n.tagName)
    ...
    function n(e) {
      ...
      if ("BR" === (n = n.nextSibling).tagName && u.node.isEditable(n))
        ...
        else u.node.deepestParent(n) && ((!u.node.isEmpty(u.node.blockParent(n)) || (u.node.blockParent(n).nextSibling && H.NO_DELETE_TAGS.indexOf(u.node.blockParent(n).nextSibling.tagName)) < 0) && h(n).remove(), s(e));
        return
      }
      if (!u.node.isBlock(n) && u.node.isEditable(n)) {
        ...
        if (u.node.isDeletable(n)) h(e).replaceWith(H.MARKERS), h(n).remove();
        else if (u.node.isList(n)) e.previousSibling ? (h(n).find("li").first().prepend(e), u.cursorLists._backspace(e)) : (h(n).find("li").first().prepend(H.MARKERS), h(e).remove());
    ...
    function l(e, t, n) {
      ...
      if (null === o)(r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? h(e).replaceWith("<".concat(r, ">").concat(H.MARKERS, "<br></").concat(r, ">")) : !e.previousSibling || h(e.previousSibling).is("br") || e.nextSibling ? h(e).replaceWith("<br>".concat(H.MARKERS)) : h(e).replaceWith("<br>".concat(H.MARKERS, "<br>"));
      else {
        var i = e,
          a = "";
        ...
        do {
          if (i = i.parentNode, !t || i !== o || t && !u.node.isBlock(o))
            if (l += u.node.closeTagString(i), i === o && u.node.isBlock(o)) c = d + c;
            else {
    ...
    function v(e, t, n) {
      ...
      if (null === r) u.html.defaultTag() && e.parentNode === u.el ? h(e).replaceWith("<".concat(u.html.defaultTag(), ">").concat(H.MARKERS, "<br></").concat(u.html.defaultTag(), ">")) : (e.nextSibling && !u.node.isBlock(e.nextSibling) || h(e).after("<br>"), h(e).replaceWith("<br>".concat(H.MARKERS)));
      else if (e.previousSibling && "IMG" == e.previousSibling.tagName || e.nextSibling && "IMG" == e.nextSibling.tagName) h(e).replaceWith("<" + u.html.defaultTag() + ">" + H.MARKERS + "<br></" + u.html.defaultTag() + ">");
      else {
        var o = e,
          i = "";
        ...
        do {
          var l = o;
          if (o = o.parentNode, "BLOCKQUOTE" === r.tagName && u.node.isEmpty(l) && !u.node.hasClass(l, "fr-marker") && h(l).contains(e) && h(l).after(e), "BLOCKQUOTE" !== r.tagName || !m(e, o) && !g(e, o))
        ...
        if ("BLOCKQUOTE" === r.tagName)
          if (e.previousSibling && u.node.isBlock(e.previousSibling) && e.nextSibling && "BR" === e.nextSibling.tagName && (h(e.nextSibling).after(e), e.nextSibling && "BR" === e.nextSibling.tagName && h(e.nextSibling).remove()), t) i = a + i + H.MARKERS + s;
          else {
    ...
    return {
      enter: function b(e) {
        ...
        0 < h(t).parentsUntil(u.$el, "BLOCKQUOTE").length && (r = !0), h(t).parentsUntil(u.$el, "TD, TH").length && (r = !1), i(t) ? !c(t) || e || r ? l(t, e, r) : u.cursorLists._endEnter(t) : a(t) ? !c(t) || e || r ? function s(e, t, n) {
            ...
            if (null === o)(r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? h(e).replaceWith("<".concat(r, ">").concat(H.MARKERS, "<br></").concat(r, ">")) : h(e).replaceWith("<br>".concat(H.MARKERS));
            else {
              if (u.node.isBlock(o))
                if ("PRE" === o.tagName && (t = !0), t) h(e).remove(), h(o).prepend("<br>".concat(H.MARKERS));
                else if (e.nextSibling && "IMG" == e.nextSibling.tagName || e.nextSibling && e.nextSibling.nextElementSibling && "IMG" == e.nextSibling.nextElementSibling) h(e).replaceWith("<" + u.html.defaultTag() + ">" + H.MARKERS + "<br></" + u.html.defaultTag() + ">");
              else {
      ...
      backspace: function E() {
        ...
        return i(t) ? c(t) && g(t, h(t).parents("li").first().get(0)) ? u.cursorLists._backspace(t) : e = f(t) : a(t) ? c(t) && g(t, h(t).parents("li").first().get(0)) ? u.cursorLists._backspace(t) : function l(e) {
          ...
          if (null !== n) {
            ...
            if (u.node.isBlock(n) && u.node.isEditable(n))
              if (a && H.NO_DELETE_TAGS.indexOf(a.tagName) < 0) {
                if (u.node.isDeletable(a)) h(a).remove(), h(e).replaceWith(H.MARKERS);
                else if (u.node.isEditable(a))
                  if (u.node.isBlock(a))
                    if (u.node.isEmpty(a) && !u.node.isList(a)) h(a).remove(), h(e).after(u.opts.keepFormatOnDelete ? H.INVISIBLE_SPACE : "");
                    else {
                      if (u.node.isList(a) && (a = h(a).find("li").last().get(0)), (i = u.node.contents(a)).length && "BR" === i[i.length - 1].tagName && h(i[i.length - 1]).remove(), "BLOCKQUOTE" === a.tagName && "BLOCKQUOTE" !== n.tagName)
                      ...
                      if (u.node.isEmpty(n)) h(e).remove(), u.selection.setAtEnd(a, !0);
                      else {
    ...
    function b(e, t, n) {
      if (e) {
        ...
        if (e) {
          ...
          if (o) {
            if (v(o).find(".fr-marker").length || "UL" === o.tagName || "OL" === o.tagName) b(o.firstChild, t, n);
            else if (m.browser.mozilla && m.node.hasClass(o, "fr-marker")) {
              var a, s = m.selection.blocks(),
                l = s.length;
    ...
    function r(e, t) {
      ...
      for (var r = !0; r;) {
        ...
        for (var o = m.node.contents(e.get(0)), i = 0; i < o.length; i++) {
          var a = o[i];
          if (a.innerHTML && 8203 == a.innerHTML.charCodeAt() && a.tagName.toLocaleLowerCase() == n && (a.outerHTML = a.innerHTML), m.node.hasClass(a, "fr-marker")) t = (t + 1) % 2;
          else if (t)
            if (0 < v(a).find(".fr-marker").length) t = d(v(a), t, n, r);
            else {
    ...
    function t(e, t) {
      ...
      if (m.selection.isCollapsed()) {
        ...
        if (m.node.openTagString(l.get(0)) === '<span style="'.concat(e, ": ").concat(l.css(e), ';">')) {
          if (m.node.isEmpty(l.get(0))) s = v(m.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(H.INVISIBLE_SPACE).concat(H.MARKERS)), l.replaceWith(s);
          else {
            var c = {};
    ...
    function N() {
      if (y.$wp) {
        ...
        var e, t, n = d(),
          r = [];
        for (t = 0; t < n.length; t++)
          if (n[t].startContainer !== y.doc || y.browser.msie) {
            var o = (e = n[t]).collapsed,
              i = y.markers.place(e, !0, t),
              a = y.markers.place(e, !1, t);
          ...
          } if (y.browser.safari && r.length)
          for (y.selection.clear(), t = 0; t < r.length; t++) y.selection.get().addRange(r[t])
      }
    }
    ...
    function A() {
      ...
      if (y.browser.msie || y.browser.edge)
          ...
          try {
            ...
            if (o.nextSibling === a || a.nextSibling === o) {
              ...
              if (h && h.nodeType === Node.TEXT_NODE)
                for (; h && h.previousSibling && h.previousSibling.nodeType === Node.TEXT_NODE;) h.previousSibling.textContent += h.textContent, h = h.previousSibling, T(h.nextSibling).remove();
              ...
              if (g && g.nodeType === Node.TEXT_NODE)
                for (; g && g.nextSibling && g.nextSibling.nodeType === Node.TEXT_NODE;) g.nextSibling.textContent = g.textContent + g.nextSibling.textContent, g = g.nextSibling, T(g.previousSibling).remove();
    ...
    return {
      ...
      element: function l() {
        ...
        try {
          if (e.rangeCount) {
            var t, n = d(0),
              r = n.startContainer;
            if (y.node.isElement(r) && 0 === n.startOffset && r.childNodes.length)
      ...
      remove: function $() {
        ...
        for (e = 0; e < r.length; e++)
          for (var o = r[e]; !(t(o) || y.node.isBlock(o.parentNode) || y.$el.is(o.parentNode) || y.node.hasClass(o.parentNode, "fr-inner"));) T(o.parentNode).before(o);
        ...
        if (function E() {
            for (var e = y.$el.find(".fr-marker"), t = 0; t < e.length; t++)
              if (T(e[t]).parentsUntil('.fr-element, [contenteditable="true"]', '[contenteditable="false"]').length) return !1;
            return !0
          }()) {
          ! function S(e, t) {
          ...
          if (s.length) y.$el.find(".fr-marker").remove(), s.append(H.INVISIBLE_SPACE + H.MARKERS).removeAttr("data-first"), s.attr("data-text") && s.replaceWith(s.html());
          else
            for (y.$el.find("table").filter(function () {
              ...
              if (d) {
                if (l && (!c || c !== d)) {
                  var f = y.node.blockParent(l),
                    p = y.node.blockParent(d),
                    u = !1,
                    h = !1;
                  if (f && 0 <= ["UL", "OL"].indexOf(f.tagName) && (u = !(f = null)), p && 0 <= ["UL", "OL"].indexOf(p.tagName) && (h = !(p = null)), T(l).after(d), f !== p)
                    if (null !== f || u)
                      if (null !== p || h || 0 !== T(f).parentsUntil(y.$el, "table").length) f && p && 0 === T(f).parentsUntil(y.$el, "table").length && 0 === T(p).parentsUntil(y.$el, "table").length && !T(f).contains(p) && !T(p).contains(f) && (T(f).append(T(p).html()), T(p).remove());
                      else {
        ...
        var v = y.$el.find(".fr-marker").last().get(0),
          b = y.$el.find(".fr-marker").first().get(0);
    ...
    language: null
  }), H.LANGUAGE = {}, H.MODULES.language = function (e) {
    var t;
    return {
      _init: function n() {
  ...
  }), H.MODULES.placeholder = function (f) {
    var p = f.$;
    ...
    function i(e) {
      ...
      var l = u();
      for (l += ",".concat(H.VOID_ELEMENTS.join(",")), l += ", .fr-inner", l += ",".concat($.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),"), ":not(.fr-marker)"), t = r.length - 1; 0 <= t; t--)
        if (!(r[t].textContent && 0 < r[t].textContent.replace(/\u200B|\n/g, "").length || 0 < r[t].querySelectorAll(l).length)) {
          for (var c = $.node.contents(r[t]), d = !1, f = 0; f < c.length; f++)
    ...
    function a(e, t) {
      ...
      if (t && (n = "div"), n) {
        for (var r = $.doc.createDocumentFragment(), o = null, i = !1, a = e.firstChild, s = !1; a;) {
          var l = a.nextSibling;
          if (a.nodeType === Node.ELEMENT_NODE && ($.node.isBlock(a) || 0 <= $.opts.htmlDoNotWrapTags.indexOf(a.tagName.toLowerCase()) && !$.node.hasClass(a, "fr-marker"))) o = null, r.appendChild(a.cloneNode(!0));
          else if (a.nodeType !== Node.ELEMENT_NODE && a.nodeType !== Node.TEXT_NODE) o = null, r.appendChild(a.cloneNode(!0));
          else if ("BR" === a.tagName) null === o ? (o = $.doc.createElement(n), s = !0, t && (o.setAttribute("class", "fr-temp-div"), o.setAttribute("data-empty", !0)), o.appendChild(a.cloneNode(!0)), r.appendChild(o)) : !1 === i && (o.appendChild($.doc.createElement("br")), t && (o.setAttribute("class", "fr-temp-div"), o.setAttribute("data-empty", !0))), o = null;
          else {
            var c = a.textContent;
    ...
    return {
      ...
      isPreformatted: s,
      emptyBlocks: i,
      emptyBlockTagsQuery: function y() {
        return "".concat(H.BLOCK_TAGS.join(":empty, "), ":empty")
      },
      blockTagsQuery: u,
      fillEmptyBlocks: function T(e) {
        var t = i(e);
      ...
      get: function _(e, t) {
        ...
        if ($.node.isEmpty($.el)) $.opts.fullPage && (n = L($.iframe_document), n += "<html".concat($.node.attributes($.$html.get(0)), ">").concat($.$html.find("head").get(0).outerHTML, "<body></body></html>"));
        else if (void 0 === e && (e = !1), $.opts.fullPage) {
          n = L($.iframe_document), $.$el.removeClass("fr-view");
          var A = $.opts.heightMin,
            M = $.opts.height,
            O = $.opts.heightMax;
      ...
      insert: function M(e, t, n) {
        ...
        if ($.selection.isCollapsed() || $.selection.remove(), r = t ? e : $.clean.html(e), e.indexOf('class="fr-marker"') < 0 && (r = function a(e) {
          ...
          }(r)), $.node.isEmpty($.el) && !$.opts.keepFormatOnDelete && f(r)) $.el.innerHTML = r;
        else {
    ...
    function s(e) {
      ...
      var r = b(n) && !m(e) && !e.altKey,
        o = n === H.KEYCODE.BACKSPACE || n === H.KEYCODE.DELETE;
    ...
    function o(e, t, n) {
      ...
      if (!t)
        if ((l = function y(e) {
          ...
          }(e)) && (e = M.win.localStorage.getItem("fr-copied-html")), l) e = M.clean.html(e, M.opts.pasteDeniedTags, M.opts.pasteDeniedAttrs);
        else {
      ...
      if ("string" == typeof d && (e = d), "" !== e) {
        ...
        if (M.opts.enter === H.ENTER_BR)
          for (r = (o = f.querySelectorAll("p, div")).length - 1; 0 <= r; r--) 0 === (i = o[r]).attributes.length && (i.outerHTML = i.innerHTML + (i.nextSibling && !M.node.isEmpty(i) ? "<br>" : ""));
        else if (M.opts.enter === H.ENTER_DIV)
          for (r = (o = f.getElementsByTagName("p")).length - 1; 0 <= r; r--) 0 === (i = o[r]).attributes.length && (i.outerHTML = "<div>".concat(i.innerHTML, "</div>"));
        else M.opts.enter === H.ENTER_P && 1 === f.childNodes.length && "P" === f.childNodes[0].tagName && 0 === f.childNodes[0].attributes.length && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML);
    ...
    function $(e) {
      ...
      for (var r = d(Array.prototype.slice.call(n.querySelectorAll(":scope > div:not([style]), td > div:not([style]), th > div:not([style]), li > div:not([style])"))); r.length;) {
        var o = r[r.length - 1];
        if (M.html.defaultTag() && "div" !== M.html.defaultTag()) o.querySelector(M.html.blockTagsQuery()) ? o.outerHTML = o.innerHTML : o.outerHTML = "<".concat(M.html.defaultTag(), ">").concat(o.innerHTML, "</").concat(M.html.defaultTag(), ">");
        else {
    ...
    return {
      _init: function p() {
        M.el.addEventListener("copy", e), M.el.addEventListener("cut", e), M.el.addEventListener("paste", t, {
          capture: !0
        }), M.events.on("drop", r), M.browser.msie && M.browser.version < 11 && (M.events.on("mouseup", function (e) {
    ...
    return {
      ...
      get: function o(e) {
        ...
        if (!r)
          for (var t in r = {}, H.SHORTCUTS_MAP) Object.prototype.hasOwnProperty.call(H.SHORTCUTS_MAP, t) && 0 <= s.opts.shortcutsEnabled.indexOf(H.SHORTCUTS_MAP[t].cmd) && (r["".concat(H.SHORTCUTS_MAP[t].cmd, ".").concat(H.SHORTCUTS_MAP[t].val || "")] = {
    ...
    "text.edit": "[_EDIT_]"
  }, H.RegisterTemplate = function (e, t) {
    ...
    function r() {
      if (S.helpers.requestAnimationFrame()(r), !1 !== S.events.trigger("position.refresh"))
        for (var e = 0; e < S._stickyElements.length; e++) t(S._stickyElements[e])
    }

    function a() {
      if (S._stickyElements)
        for (var e = 0; e < S._stickyElements.length; e++) n(S._stickyElements[e])
    }
    return {
      _init: function s() {
        ! function e() {
  ...
  }, H.TOOLBAR_BUTTONS_MD = null, (H.TOOLBAR_BUTTONS_SM = {}).moreText = Object.assign({}, H.TOOLBAR_BUTTONS.moreText, {
    buttonsVisible: 2
  }), H.TOOLBAR_BUTTONS_SM.moreParagraph = Object.assign({}, H.TOOLBAR_BUTTONS.moreParagraph, {
    buttonsVisible: 2
  }), H.TOOLBAR_BUTTONS_SM.moreRich = Object.assign({}, H.TOOLBAR_BUTTONS.moreRich, {
    buttonsVisible: 2
  }), H.TOOLBAR_BUTTONS_SM.moreMisc = Object.assign({}, H.TOOLBAR_BUTTONS.moreMisc, {
    buttonsVisible: 2
  }), (H.TOOLBAR_BUTTONS_XS = {}).moreText = Object.assign({}, H.TOOLBAR_BUTTONS.moreText, {
    buttonsVisible: 0
  }), H.TOOLBAR_BUTTONS_XS.moreParagraph = Object.assign({}, H.TOOLBAR_BUTTONS.moreParagraph, {
    buttonsVisible: 0
  }), H.TOOLBAR_BUTTONS_XS.moreRich = Object.assign({}, H.TOOLBAR_BUTTONS.moreRich, {
    buttonsVisible: 0
  }), H.TOOLBAR_BUTTONS_XS.moreMisc = Object.assign({}, H.TOOLBAR_BUTTONS.moreMisc, {
    buttonsVisible: 2
  }), H.POWERED_BY = '', H.MODULES.toolbar = function (m) {
    var v, b = m.$,
      t = [];
  ...
  h.fn = h.prototype = {
    ...
    wrapInner: function (e) {
      if ("string" == typeof e) {
        ...
        if (n < t.length && (t[n].trim() === v(e)[0].tagName && (e = document.createElement(t[n].trim())), n++), "string" != typeof e)
    ...
    outerHeight: function (e) {
      ...
      if (e && (i += parseInt(v(t).css("marginTop")) + parseInt(v(t).css("marginBottom"))), !r)
    ...
    outerWidth: function (e) {
      ...
      if (!r)
        for (var o in s) n[o] = t.style[o], t.style[o] = s[o];
      var i = t.offsetWidth;
      if (e && (i += parseInt(v(t).css("marginLeft")) + parseInt(v(t).css("marginRight"))), !r)
        for (var a in s) t.style[a] = n[a];
      return i
    },
    width: function (e) {
  ...
  return E.Bootstrap = function (e, t, n) {
    ...
    ], r.paragraphFormatSelection = !0, r.fontFamilySelection = !0, r.fontSizeSelection = !0, r.placeholderText = "", r.quickInsertEnabled = !1, r.charCounterCount = !1), this.opts = Object.assign({}, Object.assign({}, E.DEFAULTS, r, "object" === M(t) && t));
